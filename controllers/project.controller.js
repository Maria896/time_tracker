...
export const getProjectById = async (req, res) => {
  try {
    ...
    const { status, message, project } = await getProjectByid(
      ownerId,
      projectId
    );
    res.send({
...
export const getProjectByStatus = async (req, res) => {
  try {
    ...
    const { status, message, projects } = await getProjByStatus(
      ownerId,
      projectStatus
    );
    res.send({
...
// Path     :   /api/project/:projectId/:userId
// Method   :   Delete
// Access   :   Private
// Desc     :   Delete Member from project
export const deleteMemberFromProject = async (req, res) => {
  ...
  try {
    ...
    const { status, message } = await deleteMember(ownerId, projectId,userId);
    res.send({
      status: status,
      message: message,
    });
...
// Path     :   /api/project/change-status-of-the-project/:projectId/
// Method   :   Delete
// Access   :   Private
// Desc     :   Delete Member from project
export const changeProjectStatus = async (req, res) => {
  ...
  try {
    ...
    const { status, message } = await changeStatus(ownerId, projectId,projectStatus);
    res.send({
      status: status,
      message: message,
    });
